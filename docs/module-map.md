...
| 4 | `src/futon1a/model/validation.clj` | Model validation gate | `storage/schema-evolution-stability` |
...
| `src/futon1a/core/pipeline.clj` | Cross-layer write pipeline | `storage/error-layer-hierarchy` |
...
| `test/futon1a/layer3` | Authorization (penholder) |
| `test/futon1a/layer4` | Model validation |
